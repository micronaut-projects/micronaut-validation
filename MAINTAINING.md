...
We have a [template repo](https://github.com/micronaut-projects/micronaut-validation) that we use as the single
...
[Release GitHub Action workflow](https://github.com/micronaut-projects/micronaut-validation/blob/master/.github/workflows/release.yml)
