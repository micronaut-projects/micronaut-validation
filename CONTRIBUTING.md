...
Sign the [Contributor License Agreement (CLA)](https://cla-assistant.io/micronaut-projects/micronaut-validation). This is required before any of your code or pull-requests are accepted.
...
Micronaut validation currently requires JDK 8.

## IDE Setup

Micronaut validation can be imported into IntelliJ IDEA by opening the `build.gradle` file.

## Docker Setup

Micronaut validation tests currently require Docker to be installed.
