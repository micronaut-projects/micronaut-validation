...
The aggregate includes the optional bootstrap and XML modules and a Jakarta EL implementation. See the <<jakartaValidation,Jakarta Validation Compliance>> section for details.
