...
public final class MicronautValidationProvider implements ValidationProvider<MicronautValidatorConfiguration> {
    ...
    public MicronautValidatorConfiguration createSpecializedConfiguration(BootstrapState state) {
        return new MicronautValidatorConfiguration(state, false);
    }

    @Override
    public Configuration<?> createGenericConfiguration(BootstrapState state) {
        return new MicronautValidatorConfiguration(state, true);
    }

    @Override
    public ValidatorFactory buildValidatorFactory(ConfigurationState configurationState) {
        return MicronautValidatorConfiguration.buildValidatorFactory(configurationState);
    }
}
